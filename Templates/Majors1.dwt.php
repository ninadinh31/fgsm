...
<form action="<?php echo $editFormAction; ?>" method="POST" name="frmMajor" id="frmMajor">
  <table width="75%" border="3" cellspacing="0" cellpadding="0">
    <!-- TemplateBeginRepeat name="RepeatMajor" -->
      <tr>
        <td><!-- TemplateBeginEditable name="EditRegion1" -->&nbsp;
          <select name="selMajors" required id="selMajors">
            <?php
do {  
?>
...
?>
        ...
        <td><!-- TemplateBeginEditable name="EditRegion2" -->&nbsp;
          <select name="selCategory1" required id="selCategory1">
            <option>Major</option>
            <option>Minor</option>
          </select>
        <!-- TemplateEndEditable --></td>
