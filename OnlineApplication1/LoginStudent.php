...
if (isset($_POST['Username'])) {
  ...
  $MM_redirectLoginSuccess = "CurrentStudents.php";
  $MM_redirectLoginFailed = "LoginStudent.php";
  ...
  if ($loginFoundUser) {
	...
	?> <script>
  		alert('Invalid login credentials for this page. Try again or contact globalsemesterdc@umd.edu.');
...
<form ACTION="<?php echo $loginFormAction; ?>" id="frmLogin" name="frmLogin" method="POST">
  <table width="677" border="1" cellpadding="1">
    <tbody>
      <tr>
        <td width="236" bgcolor="#A3C9C3"><h2 style="text-align: left">Student Log In</h2>          <h3>
