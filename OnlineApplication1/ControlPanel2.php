...
$rsLanguages = mysql_query($query_limit_rsLanguages, $FGSP) or die(mysql_error());
...
$rsViewScholarship = mysql_query($query_limit_rsViewScholarship, $FGSP) or die(mysql_error());
...
$rsStudyAbroad = mysql_query($query_limit_rsStudyAbroad, $FGSP) or die(mysql_error());
...
<h2 align="center">Welcome to the Federal and Global Semester 2016 -  2017 Online Application System<br><a href="Admin1.php">Admin</a> | <a href="Logout1.php"> Log Out</a></h2>
<p align="center">Welcome
<?php echo $row_rstViewRegistration['Firstname']; ?>! <?php echo $row_rstViewRegistration['UID']; ?></p>
<form action="<?php echo $editFormAction; ?>" id="frmControlPanel" name="frmControlPanel" method="POST">
  ...
  <div id="Tabs1">
    ...
    <div id="tabs-1">
      ...
      <table align="center" width="987" border style="0">
        <tbody>
          <tr>
            ...
            <td width="219"><?php echo $row_rsApplication['Seniority']; ?></td>
            <td width="183"><strong>Citizenship</strong></td>
            <td width="446"><?php echo $row_rsApplication['Citizenship']; ?></td>
          </tr>
          <tr>
            <td><strong>Gender</strong></td>
            <td><?php echo $row_rsApplication['Gender']; ?></td>
            <td rowspan="2"><strong>General Internship Interest</strong></td>
            <td rowspan="2"><?php echo $row_rsApplication['InternshipInterest']; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td rowspan="2"><?php echo $row_rsApplication['PastInternLocation']; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo date("m/d/Y", strtotime($row_rsApplication['Graduation'])); ?></td>
            <td rowspan="2"><strong>If Interning in Fall, please specify location</strong></td>
            <td rowspan="2"><?php echo $row_rsApplication['FallInternLoc']; ?></td>
          </tr>
          <!-- <tr>
            <td><input name="UserID" type="hidden" id="UserID" value="<?php// echo $row_rstViewRegistration['UserID']; ?>"></td>
          </tr> -->
        </tbody>
      </table>
      <p align="center">
      <input name="EditBackground" type="button" class="button" id="EditBackground" onClick="MM_goToURL('parent','EditBackground1.php');return document.MM_returnValue" value="Edit Background"> </p><br>
      <p align="center"><strong>Citizenship</strong></p>
      
      <table align="center" width="856" border="1">
      	<thead>
        	<th>Country</th>
            <th>&nbsp;</th>
        <td width="355"></thead>
        ...
        <?php do { ?>
          <tr>
            ...
            <td width="116"><a href="DeleteCountry1.php?UID=<?php echo $row_rsCitizenshipList['UID'];?> && CountryID=<?php echo 	  $row_rsCitizenshipList['CountryID'];?>">Delete Country</a></td>
          </tr>
      ...
      <p align="center"> 
      <input name="AddCitizenship" type="button" id="AddCitizenship" onClick="MM_goToURL('parent','Citizenship1.php');return document.MM_returnValue" value="Add Citizenship"> </p><br>
      ...
      <?php do { ?>
        ...
        <?php } while ($row_rsLanguages = mysql_fetch_assoc($rsLanguages)); ?>
      <p align="center">
    ...
    <h3 align="center">University Programs</h3>
      ...
      <p align="center"><input name="Add University Programs" type="button" id="AddUniPrograms" onClick="MM_goToURL('parent','UniversityPrograms.php');return document.MM_returnValue" value="Add University Programs"></p>
        <br>
	  ...
	  <h3 align="center">Study Abroad Experience</h3>
        <table align="center" width="895" border="1">
          <tbody>
            <tr>
              <td width="294"><strong>Institution/Location
      ...
      <p align="center">
    <input name="butAddStudyAbroad" type="button" id="butAddStudyAbroad" onClick="MM_goToURL('parent','AddStudyAbroad1.php');return document.MM_returnValue" value="Add Study Abroad"></p></div>
    <div id="tabs-4">
