...
<h2><strong>Search Applications</strong> by Name</h2>
<form name="form1" method="post" action="ApplicationSrcResult1.php">
  <table width="300" border="1">
    <tbody>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input name="submit" type="submit" id="submit" formaction="ApplicationSrcResult1.php" formmethod="GET" value="Search"></td>
      </tr>
    </tbody>
  </table>
</form>
