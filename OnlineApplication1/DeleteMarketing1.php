...
if ((isset($_GET['UID'])) && ($_GET['UID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tblsqmarketingdetails WHERE `UID`=%s AND `PgmYear`=%s AND `MarketingID`=%s",
                 GetSQLValueString($_GET['UID'], "int"),      
				 GetSQLValueString($_GET['PgmYear'], "date"),
				 GetSQLValueString($_GET['MarketingID'], "int"));
