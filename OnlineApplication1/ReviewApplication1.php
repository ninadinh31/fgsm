        ...
        <td><table width="880" height="53" border="1">
          <tbody>
            ...
            <tr>
              ...
              <td><input name="txtdocID" type="hidden" id="txtdocID" value="<?php echo $row_rsDocuments['docID']; ?>"> <a href="DeleteDoc1.php?docID=<?php echo $row_rsDocuments['docID'] ?>">Delete</a></td>
            </tr>
